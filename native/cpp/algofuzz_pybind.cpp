...
PYBIND11_MODULE(_algofuzz, m)
{
	...
	py::class_<BaseFCM>(m, "BaseFCM")
		...
		.def_static("get_parameter_names", &BaseFCM::getParameterNames,
	...
	py::class_<FCM, BaseFCM>(m, "FCM")
		...
		.def("fit", &FCM::fit,
			 ...
			 py::arg("X"))
		.def_static("get_parameter_names", &FCM::getParameterNames,
					"Get the names of the parameters");
	...
	py::class_<STPFCM, BaseFCM>(m, "STPFCM")
		...
		.def("get_eta", &STPFCM::getEta,
			 "Get the eta matrix")
		.def_static("get_parameter_names", &STPFCM::getParameterNames,
					"Get the names of the parameters");
	...
	py::class_<FCPlus1M, FCM>(m, "FCPlus1M")
		...
		.def("fit", &FCPlus1M::fit,
			 ...
			 py::arg("X"))
		.def_static("get_parameter_names", &FCPlus1M::getParameterNames,
					"Get the names of the parameters");
	...
	py::class_<EtaFCM, FCM>(m, "EtaFCM")
		...
		.def("get_eta", &EtaFCM::getEta,
			 "Get the eta vector")
		.def_static("get_parameter_names", &EtaFCM::getParameterNames,
					"Get the names of the parameters");

	py::class_<EtaPlus1FCM, FCPlus1M>(m, "EtaPlus1FCM")
		.def(py::init<int, int, float, float, float>(),
			 py::arg("num_clusters"),
			 py::arg("max_iter") = 150,
			 py::arg("m") = 2.0f,
			 py::arg("kappa") = 1.0f,
			 py::arg("noise") = 0.0f)
		.def("set_parameters", &EtaPlus1FCM::setParameters,
			 "Set parameters for the EtaPlus1FCM model from a dictionary")
		.def("fit", &EtaPlus1FCM::fit,
			 "Fit the EtaPlus1FCM model to the data",
			 py::arg("X"))
		.def("get_eta", &EtaPlus1FCM::getEta,
			 "Get the eta vector")
		.def_static("get_parameter_names", &EtaPlus1FCM::getParameterNames,
					"Get the names of the parameters");
	;
	...
	py::class_<FP3CM, BaseFCM>(m, "FP3CM")
		...
		.def("fit", &FP3CM::fit,
			 ...
			 py::arg("X"))
		.def_static("get_parameter_names", &FP3CM::getParameterNames,
					"Get the names of the parameters");
	...
	py::class_<GFPCM, BaseFCM>(m, "GFPCM")
		...
		.def("fit", &GFPCM::fit,
			 ...
			 py::arg("X"))
		.def_static("get_parameter_names", &GFPCM::getParameterNames,
					"Get the names of the parameters");

	py::class_<PFCM, BaseFCM>(m, "PFCM")
		.def(py::init<int, int, float, int, float, float, float, float, bool>(),
			 py::arg("num_clusters"),
			 py::arg("max_iter") = 150,
			 py::arg("m") = 2.0f,
	...
	py::class_<FPCM, GFPCM>(m, "FPCM")
		...
		.def("fit", &FPCM::fit, // Inherited from GFPCM
			 ...
			 py::arg("X"))
		.def_static("get_parameter_names", &FPCM::getParameterNames,
					"Get the names of the parameters");
